...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 03 nov. 2019 à 15:24
...
INSERT INTO `gallery` (`id`, `countrycode`, `name`, `description`, `extension`) VALUES
(1, 'FRA', 'Koala', 'Description du koala                        ', 'jpeg'),
(2, 'FRA', 'Osselait', 'Description de Osselait   ', 'png');
...
--
ALTER TABLE `gallery`
  ADD CONSTRAINT `countrycode_fk` FOREIGN KEY (`countrycode`) REFERENCES `country` (`code`);
COMMIT;
